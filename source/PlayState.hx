...
{
	var thisisverysus:FlxSprite;

	public static var dadMoveX:Int = 0;
	public static var dadMoveY:Int = 0;

	public static var bfMoveX:Int = 0;
	public static var bfMoveY:Int = 0;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'snow':
				defaultCamZoom = 0.7;
				curStage = 'snow';
				var bg1:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bg1'));
				...
				var bg2:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bg2'));
				...
				var bg3:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('bg3'));
		...
		if(curStage == 'snow')
			{
				thisisverysus = new FlxSprite().loadGraphic(Paths.image('wha2'));
				thisisverysus.antialiasing = ClientPrefs.globalAntialiasing;
				thisisverysus.cameras = [camHUD];
				thisisverysus.alpha = 0;
				add(thisisverysus);
			}
								...
								if (!note.isSustainNote)
									{
										...
										{
											case 0:
												thisisverysus.color = FlxColor.fromString('#C24B99');
												thisisverysus.alpha = 0;
												FlxTween.tween(thisisverysus, {alpha: 0.3}, 0.1, {ease: FlxEase.quartInOut});
											case 1:
												thisisverysus.color = FlxColor.fromString('#00FFFF');
												thisisverysus.alpha = 0;
												FlxTween.tween(thisisverysus, {alpha: 0.3}, 0.1, {ease: FlxEase.quartInOut});
											case 2:
												thisisverysus.color = FlxColor.fromString('#12FA05');
												thisisverysus.alpha = 0;
												FlxTween.tween(thisisverysus, {alpha: 0.3}, 0.1, {ease: FlxEase.quartInOut});
											case 3:
												thisisverysus.color = FlxColor.fromString('#F9393F');
												thisisverysus.alpha = 0;
												FlxTween.tween(thisisverysus, {alpha: 0.3}, 0.1, {ease: FlxEase.quartInOut});
										}
									}
	...
	function showNote()
		{
			...
			ohwow.loadGraphic(Paths.image('snow', 'shared'));
			ohwow.updateHitbox();
			ohwow.alpha = 0;
			...
			omgPopUp = false;
			ohwow.setGraphicSize(Std.int(ohwow.width * 2));
			ohwow.updateHitbox();
			...
			{
				FlxTween.tween(ohwow, {width: 0, alpha: 0}, 0.2, {ease: FlxEase.sineOut});
			});
